...
const DATA = {
  ...
  blurb: "",
  intro: [
    <>I'm a <strong>Research Assistant</strong> in the <strong>TRAIL Lab</strong> at the University at Buffalo, advised by <a href="https://www.buffalo.edu/cubs/members.host.html/content/shared/engineering/computer-science-engineering/profiles/faculty/ladder/ratha-nalini.html" target="_blank" rel="noreferrer">Dr. Nalini Ratha</a>. My work sits at the intersection of <em>theoretical reinforcement learning</em> and its <em>applications to robotics</em>.</>,
  ...
  links: [
    { label: "CV", href: "https://drive.google.com/file/d/11lGp_z9Mt0sq-a7LTaWLhCgj9pHdcnHy/view?usp=sharing" },
